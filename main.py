...
def attack(char_name: str, char_class: str) -> str:
    """В зависимости от класса персонажа вычитает урон."""
...
def defence(char_name: str, char_class: str) -> str:
    """В зависимости от класса персонажа блокирует
...
def start_training(char_name: str, char_class: str) -> str:
    """Описывает класс персонажа и учит командам."""
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Функция запрашивает данные и на их основе выдает класс персонажа."""
    approve_choice: str = ''
    char_class: str = ''
